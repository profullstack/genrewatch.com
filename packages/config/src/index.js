...
export const config = {
  ...
  playlists: {
     ...
     * list is 8MB or 583MB. Bandwidth is bounded separately and better by
   ...
   *
   * Same names and same defaults as the sibling brand, so the two sites can be
   * reasoned about together and a variable set on one means the same on the other.
   */
  membership: {
   ...
   *
   * Same names and same defaults as the sibling brand, so a price change is one
   * variable set twice rather than two different products.
   */
  live: {
     ...
     * Changing it affects lines created afterwards only.
     */
   ...
   * an x402 offer instead, and paying it buys a pass. Both numbers are
